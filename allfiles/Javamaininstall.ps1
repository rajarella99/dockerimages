...
function jreinstall {
    ...
    if ($null -eq (Get-Command cmd -ErrorAction SilentlyContinue)) {
        ...
        & cmd /c start /wait C:\jre8u351.exe INSTALL_SILENT=Enable SPONSORS=Disable NOSTARTMENU=Enable REBOOT=Disable EULA=Disable AUTO_UPDATE=Disable STATIC=Enable
...
## JAVA CMD INSTALL ##
#start /wait C:\jre8u351.exe INSTALL_SILENT=Enable SPONSORS=Disable NOSTARTMENU=Enable REBOOT=Disable EULA=Disable AUTO_UPDATE=Disable STATIC=Enable
