...
Write-Host "The current Subscription is "$currentsubscription.Subscription.Name" " -ForegroundColor Yellow
...
Write-Host -ForegroundColor Yellow  "Error sending image to azure container registry" $_.Exception.Message
throw $_
}
finally {
