...
$templatefile = ".\linuxcontainertemplate.json" ## you'll need to provide this json template absolute path in this variable here from wherever you're calling this ARM file using script##
